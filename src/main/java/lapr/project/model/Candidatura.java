...
public class Candidatura {
    ...
    public Candidatura(Utilizador representante, String nome_Empresa, String morada_Empresa, int telemovel_Empresa, int qtd_convites, float area_Empresa, ListaProdutos lista_produtos) {
    ...
    public String toString(){
        return "Candidatura:\tNome da Empresa: " + this.nome_Empresa + "\tRepresentante: "+ this.representante.toString();
    }
